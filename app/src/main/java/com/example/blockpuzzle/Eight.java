...
public class Eight extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        if (view.getId()==B[49].getId())
        {
            String S = (String) B[49].getText();
            if (B[41].getText().equals(" "))
            {
                B[41].setText(S);
                B[49].setText(" ");
        ...
        if (view.getId()==B[50].getId())
        {
            String S = (String) B[50].getText();
            if (B[42].getText().equals(" "))
            {
                B[42].setText(S);
                B[50].setText(" ");
        ...
        if (view.getId()==B[51].getId())
        {
            String S = (String) B[51].getText();
            if (B[43].getText().equals(" "))
            {
                B[43].setText(S);
                B[51].setText(" ");
        ...
        if (view.getId()==B[52].getId())
        {
            String S = (String) B[52].getText();
            if (B[44].getText().equals(" "))
            {
                B[44].setText(S);
                B[52].setText(" ");
        ...
        if (view.getId()==B[53].getId())
        {
            String S = (String) B[53].getText();
            if (B[45].getText().equals(" "))
            {
                B[45].setText(S);
                B[53].setText(" ");
        ...
        if (view.getId()==B[54].getId())
        {
            String S = (String) B[54].getText();
            if (B[46].getText().equals(" "))
            {
                B[46].setText(S);
                B[54].setText(" ");
            ...
            if (B[62].getText().equals(" "))
            {
                B[62].setText(S);
                B[54].setText(" ");
            }
        }
        if (view.getId()==B[55].getId())
        {
            String S = (String) B[55].getText();
            if (B[47].getText().equals(" "))
            {
                B[47].setText(S);
                B[55].setText(" ");
        ...
        if (view.getId()==B[56].getId())
        {
            String S = (String) B[56].getText();
            if (B[48].getText().equals(" "))
            {
                B[48].setText(S);
                B[56].setText(" ");
        ...
        if (view.getId()==B[57].getId())
        {
            String S = (String) B[57].getText();
            if (B[49].getText().equals(" "))
            {
                B[49].setText(S);
                B[57].setText(" ");
        ...
        if (view.getId()==B[58].getId())
        {
            String S = (String) B[58].getText();
            if (B[50].getText().equals(" "))
            {
                B[50].setText(S);
                B[58].setText(" ");
        ...
        if (view.getId()==B[59].getId())
        {
            String S = (String) B[59].getText();
            if (B[51].getText().equals(" "))
            {
                B[51].setText(S);
                B[59].setText(" ");
        ...
        if (view.getId()==B[60].getId())
        {
            String S = (String) B[60].getText();
            if (B[52].getText().equals(" "))
            {
                B[52].setText(S);
                B[60].setText(" ");
        ...
        if (view.getId()==B[61].getId())
        {
            String S = (String) B[61].getText();
            if (B[53].getText().equals(" "))
            {
                B[53].setText(S);
                B[61].setText(" ");
        ...
        if (view.getId()==B[62].getId())
        {
            String S = (String) B[62].getText();
            if (B[54].getText().equals(" "))
            {
                B[54].setText(S);
                B[62].setText(" ");
        ...
        if (view.getId()==B[63].getId())
        {
            String S = (String) B[63].getText();
            if (B[55].getText().equals(" "))
            {
                B[55].setText(S);
                B[63].setText(" ");
        ...
        if (view.getId() == New.getId())
        {
            ...
            B[42].setText(S);
            S = (String) B[4].getText();
            B[4].setText(B[63].getText());
            B[63].setText(S);
            S = (String) B[7].getText();
            B[7].setText(B[60].getText());
            B[60].setText(S);
            S = (String) B[50].getText();
            B[50].setText(B[27].getText());
            B[27].setText(S);
            S = (String) B[36].getText();
            B[36].setText(B[58].getText());
            B[58].setText(S);
            S = (String) B[20].getText();
            B[20].setText(B[56].getText());
            B[56].setText(S);
        ...
        if (view.getId() == Sol.getId())
        {
            ...
            B[35].setText("36");  B[36].setText("37");  B[37].setText("38");  B[38].setText("39");  B[39].setText("40");
            B[40].setText("41");  B[41].setText("42");  B[42].setText("43");  B[43].setText("44");  B[44].setText("45");
            B[45].setText("46");  B[46].setText("47");  B[47].setText("48");  B[48].setText("49");  B[49].setText("50");
            B[50].setText("51");  B[51].setText("52");  B[52].setText("53");  B[53].setText("54");  B[54].setText("55");
            B[55].setText("56");  B[56].setText("57");  B[57].setText("58");  B[58].setText("59");  B[59].setText("60");
            B[60].setText("61");  B[61].setText("62");  B[62].setText("63");  B[63].setText(" ");
        ...
        {
            Intent IBack;
            IBack = new Intent(Eight.this , LevelPage.class);
            startActivity(IBack);
        }
        ...
        if (B[0].getText().equals("1") && B[1].getText().equals("2") && B[2].getText().equals("3") &&
                ...
                B[48].getText().equals("49") && B[49].getText().equals("50") && B[50].getText().equals("51") &&
                B[51].getText().equals("52") && B[52].getText().equals("53") && B[53].getText().equals("54") &&
                B[54].getText().equals("55") && B[55].getText().equals("56") && B[56].getText().equals("57") &&
                B[57].getText().equals("58") && B[58].getText().equals("59") && B[59].getText().equals("60") &&
                B[60].getText().equals("61") && B[61].getText().equals("62") && B[62].getText().equals("63") &&
                B[63].getText().equals(" "))
        {
            Win();
        }
    ...
    public void Win()
    {
        dialogWin = new Dialog(Eight.this);
        ...
        dialogWin.findViewById(R.id.Next).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent INext;
                INext = new Intent(Eight.this , LevelPage.class);
                startActivity(INext);
            }
        });
        dialogWin.show();
    ...
    public void Loss()
    {
        dialogLoss = new Dialog(Eight.this);
        ...
        dialogLoss.findViewById(R.id.ReStart).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent Irestart;
                Irestart = new Intent(Eight.this , Eight.class);
