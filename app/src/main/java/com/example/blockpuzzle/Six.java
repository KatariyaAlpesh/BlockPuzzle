...
public class Six extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void onClick(View view)
    {
        ...
        if (view.getId() == Set.getId())
        {
            ...
            B[16].setText(S);
            S = (String) B[11].getText();
            B[11].setText(B[34].getText());
            B[34].setText(S);
        ...
        if (view.getId() == New.getId())
        {
            ...
            B[28].setText(S);
            S = (String) B[17].getText();
            B[17].setText(B[13].getText());
            B[13].setText(S);
            S = (String) B[12].getText();
            B[12].setText(B[16].getText());
            B[16].setText(S);
            S = (String) B[11].getText();
            B[11].setText(B[33].getText());
            B[33].setText(S);
            S = (String) B[9].getText();
            B[9].setText(B[22].getText());
            B[22].setText(S);
        ...
        {
            Intent IBack;
            IBack = new Intent(Six.this , LevelPage.class);
            startActivity(IBack);
        }
        ...
        if (B[0].getText().equals("1") && B[1].getText().equals("2") && B[2].getText().equals("3") &&
            ...
            B[33].getText().equals("34") && B[34].getText().equals("35") && B[35].getText().equals(" ") )
        {
            Win();
        }
    }
    ...
    public void Win()
    {
        ...
        dialogWin.findViewById(R.id.Next).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent INext;
                INext = new Intent(Six.this , Seven.class);
                startActivity(INext);
            }
        });
        dialogWin.show();
    ...
    public void Loss()
    {
        dialogLoss = new Dialog(Six.this);
        ...
        dialogLoss.findViewById(R.id.ReStart).setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent Irestart;
                Irestart = new Intent(Six.this , Six.class);
